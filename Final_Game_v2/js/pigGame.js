...
var pigGame = {
    ...
    strike: function (cloud) {
        if (cloud.position.x < 1280 && cloud.position.x > 0) {
    ...
    update: function () {
        ...
        if (cloudlayer2 != null) {
            ...
            if (cloudlayer.position.x == -1000) {
                ...
                // console.log("THERE");
                // console.log("LAYER 2 " + cloudlayer2.position.x);
            }
        }
        ...
        thunderClouds.forEach(function (cloud) {
            ...
            if (y > 50 && game.time.now - strikeCheck > 1000 && !gameOverbool) {
                this.strike(cloud);
            }
        ...
        if (cleanKey.isDown) {
            ...
            //console.log(cloudlayer.position.x);
